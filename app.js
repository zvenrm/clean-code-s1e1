...
var createNewTaskElement = function (taskString) {
  ...
  listItem.className = "section__content"
  ...
  deleteButton.className = "main__button delete-button";
...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("section__edit");
  ...
  listItem.classList.toggle("section__edit");
};
